...
class ThemeZee_Addons_Page {
	...
	*/
	static function add_addons_page() {
		...
		add_theme_page(
			esc_html__( 'ThemeZee Add-ons', 'themezee-widget-bundle' ),
			esc_html__( 'Theme Add-ons', 'themezee-widget-bundle' ),
			'manage_options',
			'themezee-addons',
	...
	*/
	static function display_overview_page() { 
		...
		$addon_link = '<a target="_blank" href="http://themezee.com/addons/" title="'. esc_html__( 'ThemeZee Add-ons', 'themezee-widget-bundle' ) . '">'. esc_html__( 'add-ons', 'themezee-widget-bundle' ) . '</a>';
		?>
